...
use CodeSpanish\Bundle\MyMoviesBundle\Form\CountryType;
...
class CountryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CodeSpanishMyMoviesBundle:Country')->findAll();
     ...
     * @Method("POST")
     * @Template("CodeSpanishMyMoviesBundle:Country:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CodeSpanishMyMoviesBundle:Country')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CodeSpanishMyMoviesBundle:Country:edit.html.twig")
     */
