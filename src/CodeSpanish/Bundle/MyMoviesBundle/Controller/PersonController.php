...
use CodeSpanish\Bundle\MyMoviesBundle\Form\PersonType;
...
class PersonController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CodeSpanishMyMoviesBundle:Person')->findAll();
     ...
     * @Method("POST")
     * @Template("CodeSpanishMyMoviesBundle:Person:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CodeSpanishMyMoviesBundle:Person')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CodeSpanishMyMoviesBundle:Person:edit.html.twig")
     */
