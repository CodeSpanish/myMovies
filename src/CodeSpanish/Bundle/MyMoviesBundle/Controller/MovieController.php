...
use CodeSpanish\Bundle\MyMoviesBundle\Form\MovieType;
...
class MovieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CodeSpanishMyMoviesBundle:Movie')->findAll();
     ...
     * @Method("POST")
     * @Template("CodeSpanishMyMoviesBundle:Movie:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CodeSpanishMyMoviesBundle:Movie')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CodeSpanishMyMoviesBundle:Movie:edit.html.twig")
     */
