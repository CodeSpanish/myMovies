...
use CodeSpanish\Bundle\MyMoviesBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CodeSpanishMyMoviesBundle:Role')->findAll();
     ...
     * @Method("POST")
     * @Template("CodeSpanishMyMoviesBundle:Role:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CodeSpanishMyMoviesBundle:Role')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CodeSpanishMyMoviesBundle:Role:edit.html.twig")
     */
